  ...
  return (
    <div className="rounded-[32px] border border-slate-800/70 bg-slate-950/80 p-6 shadow-[0_40px_90px_rgba(15,23,42,0.32)] glass-card">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="rounded-3xl bg-sky-500/10 px-4 py-3 text-sm font-semibold text-sky-200 shadow-[0_12px_30px_rgba(56,189,248,0.16)]">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <div className="rounded-[28px] border border-slate-800/70 bg-slate-900/80 p-5">
          ...
          <div className="mt-4 flex items-end justify-between gap-4">
            ...
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-sky-500/15 text-sky-200 shadow-[0_16px_40px_rgba(56,189,248,0.16)]">
          ...
          <button
            ...
            className="mt-6 inline-flex items-center gap-2 rounded-full border border-slate-700/80 bg-slate-900/80 px-4 py-3 text-sm font-semibold text-slate-200 transition hover:bg-slate-800"
          >
          ...
          {showTimeSettings && (
            <div className="mt-5 rounded-[24px] border border-slate-800/70 bg-slate-950/90 p-4 shadow-[0_20px_40px_rgba(15,23,42,0.16)]">
              ...
              <div className="mt-3 flex flex-wrap gap-3">
                {presetTimes.map((minutes) => (
                  <button
                    ...
                    className="rounded-full border border-slate-800/70 bg-slate-900/85 px-4 py-2 text-sm font-semibold text-slate-100 transition hover:border-sky-400 hover:text-sky-200"
                  >
                    {minutes} min
                  </button>
                ))}
              ...
              <div className="mt-4 flex items-center gap-3">
                <input
                  ...
                  className="w-24 rounded-2xl border border-slate-800/70 bg-slate-900/80 px-3 py-2 text-sm text-slate-100 outline-none"
                />
                <button
                  type="button"
        ...
        <div className="rounded-[28px] border border-slate-800/70 bg-slate-900/80 p-5">
          ...
          <select
            ...
            className="mt-4 w-full rounded-[24px] border border-slate-800/70 bg-slate-950/90 px-4 py-3 text-sm text-slate-100 outline-none transition focus:border-sky-400"
          >
          ...
          <div className="mt-6 rounded-[28px] border border-slate-800/70 bg-slate-950/90 p-4">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="inline-flex items-center gap-2 rounded-full bg-slate-900/90 px-3 py-2 text-xs font-semibold text-emerald-300">
                <CheckCircle2 className="h-4 w-4" />
                {photoVerified ? 'Verified' : 'Pending'}
              </div>
            </div>

            <div className="mt-5 overflow-hidden rounded-[24px] bg-slate-900/95 shadow-[0_24px_60px_rgba(15,23,42,0.18)]">
              <img
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-[1fr_auto]">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-800/70 bg-slate-900/90 px-4 py-3 text-sm font-semibold text-slate-100 transition hover:bg-slate-800"
              >
